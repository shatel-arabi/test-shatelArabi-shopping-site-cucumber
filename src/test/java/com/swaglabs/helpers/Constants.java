...
public class Constants {
    ...
    public static final String DEFAULT_DIRECTORY = SystemUtils.IS_OS_WINDOWS ? "C:/selenium-tests-downloads/" : System.getProperty("user.home") + "/selenium-tests-downloads/";
